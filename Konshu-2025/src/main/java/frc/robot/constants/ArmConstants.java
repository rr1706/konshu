...
public class ArmConstants {
  ...
  public static final double kArmP = 135.0;   // Output per unit of error in position (volts/rotation)
  public static final double kArmI = 0.0;   // Output per unit of integrated error in position (volts/(rotation*s))
  public static final double kArmD = 25.0;   // Output per unit of error in velocity (volts/rotation)
  ...
  public static final double kArmCruiseVelocity = 0.5;
  public static final double kArmAcceleration = 3.0;
  ...
  public static final double kArmL1 = 10.0;    //10.0 before tuning //12.9 actual // Degrees from arm hortizontal
