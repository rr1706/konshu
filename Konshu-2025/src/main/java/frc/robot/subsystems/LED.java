...
public class LED extends SubsystemBase
{
  ...
  {
    //TODO
    boolean isHoldingCoral = false; // update this with some method of finding hold status - Boolean from CLAW
  ...
  public void leftStrand(Color ledColor, boolean ledPattern)
  {
    ...
    if (ledPattern == m_isSolid)
    {
      left = LEDPattern.solid(ledColor);
    }
    else
    {
      left = LEDPattern.gradient(GradientType.kDiscontinuous, ledColor, m_black);
    }
  ...
  {
    // Create the view for the section of the strip on the right side of the robot.
    ...
    {
      right = LEDPattern.gradient(GradientType.kDiscontinuous, ledColor, m_black);
    }
