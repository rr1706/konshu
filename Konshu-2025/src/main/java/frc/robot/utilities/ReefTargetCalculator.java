...
public class ReefTargetCalculator {
   ...
   //     String mode = alignMode.toUpperCase();
        ...
        if (alliance == DriverStation.Alliance.Blue) {
            if (DriverStation.getStickButton(1, ButtonConstants.kCoralA)) {
                switch (alignMode) {
                    case LEFT:
                        return new Pose2d(AutoAlignConstants.BlueAllianceConstants.kAL, null);
                    case RIGHT:
                        return new Pose2d(AutoAlignConstants.BlueAllianceConstants.kAR, null);
                    case ALGAE:
                ...
                switch (alignMode) {
                    case LEFT:
                        return new Pose2d(AutoAlignConstants.BlueAllianceConstants.kBL, null);
                    case RIGHT:
                        return new Pose2d(AutoAlignConstants.BlueAllianceConstants.kBR, null);
                    case ALGAE:
                ...
                switch (alignMode) {
                    case LEFT:
                        return new Pose2d(AutoAlignConstants.BlueAllianceConstants.kCL, null);
                    case RIGHT:
                        return new Pose2d(AutoAlignConstants.BlueAllianceConstants.kCR, null);
                    case ALGAE:
                ...
                switch (alignMode) {
                    case LEFT:
                        return new Pose2d(AutoAlignConstants.BlueAllianceConstants.kDL, null);
                    case RIGHT:
                        return new Pose2d(AutoAlignConstants.BlueAllianceConstants.kDR, null);
                    case ALGAE:
                ...
                switch (alignMode) {
                    case LEFT:
                        return new Pose2d(AutoAlignConstants.BlueAllianceConstants.kEL, null);
                    case RIGHT:
                        return new Pose2d(AutoAlignConstants.BlueAllianceConstants.kER, null);
                    case ALGAE:
                ...
                switch (alignMode) {
                    case LEFT:
                        return new Pose2d(AutoAlignConstants.BlueAllianceConstants.kFL, null);
                    case RIGHT:
                        return new Pose2d(AutoAlignConstants.BlueAllianceConstants.kFR, null);
                    case ALGAE:
        ...
        // Red Alliance button polling.
            ...
            if (DriverStation.getStickButton(1, ButtonConstants.kCoralA)) {
                switch (alignMode) {
                    case LEFT:
                        return new Pose2d(AutoAlignConstants.RedAllianceConstants.kAL, null);
                    case RIGHT:
                        return new Pose2d(AutoAlignConstants.RedAllianceConstants.kAR, null);
                    case ALGAE:
                ...
                switch (alignMode) {
                    case LEFT:
                        return new Pose2d(AutoAlignConstants.RedAllianceConstants.kBL, null);
                    case RIGHT:
                        return new Pose2d(AutoAlignConstants.RedAllianceConstants.kBR, null);
                    case ALGAE:
                ...
                switch (alignMode) {
                    case LEFT:
                        return new Pose2d(AutoAlignConstants.RedAllianceConstants.kCL, null);
                    case RIGHT:
                        return new Pose2d(AutoAlignConstants.RedAllianceConstants.kCR, null);
                    case ALGAE:
                ...
                switch (alignMode) {
                    case LEFT:
                        return new Pose2d(AutoAlignConstants.RedAllianceConstants.kDL, null);
                    case RIGHT:
                        return new Pose2d(AutoAlignConstants.RedAllianceConstants.kDR, null);
                    case ALGAE:
                ...
                switch (alignMode) {
                    case LEFT:
                        return new Pose2d(AutoAlignConstants.RedAllianceConstants.kEL, null);
                    case RIGHT:
                        return new Pose2d(AutoAlignConstants.RedAllianceConstants.kER, null);
                    case ALGAE:
                ...
                switch (alignMode) {
                    case LEFT:
                        return new Pose2d(AutoAlignConstants.RedAllianceConstants.kFL, null);
                    case RIGHT:
                        return new Pose2d(AutoAlignConstants.RedAllianceConstants.kFR, null);
                    case ALGAE:
